...
// Theme Options
$rodich_sidebar_position = cs_get_option('single_sidebar_position');
...
<div class="roch-blog-single-area <?php echo esc_attr($rodich_content_padding); ?>" style="<?php echo esc_attr($rodich_custom_padding); ?>">
