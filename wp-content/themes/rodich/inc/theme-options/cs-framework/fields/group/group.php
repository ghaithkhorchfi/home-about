...
class CSFramework_Option_group extends CSFramework_Options {
  ...
  public function output() {
    ...
    $acc_title   = ( isset( $this->field['accordion_title'] ) ) ? $this->field['accordion_title'] : esc_html__( 'Adding', 'rodich' );
    ...
    echo '<div class="cs-group cs-group-'. $el_class .'-adding hidden">';
      ...
      echo '<div class="cs-element cs-text-right cs-remove"><a href="#" class="button cs-warning-primary cs-remove-group">'. esc_html__( 'Remove', 'rodich' ) .'</a></div>';
      echo '</div>';
