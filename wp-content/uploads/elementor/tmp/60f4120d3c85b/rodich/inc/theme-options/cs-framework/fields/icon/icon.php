...
class CSFramework_Option_icon extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<a href="#" class="button button-primary cs-icon-add">'. esc_html__( 'Add Icon', 'rodich' ) .'</a>';
    echo '<a href="#" class="button cs-warning-primary cs-icon-remove'. $hidden .'">'. esc_html__( 'Remove Icon', 'rodich' ) .'</a>';
