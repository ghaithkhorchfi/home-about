...
if ($rodich_page_layout_meta) {
	$rodich_page_layout_position = $rodich_page_layout_meta['page_layout'];
} else {
	$rodich_page_layout_position = '';
}

// Sidebar Position
if ($rodich_page_layout_position === 'full-width') {
	$main_class = ' roch-blog-single-area ';
	$main_container_class = ' container ';
	$layout_class = '';
} elseif ($rodich_page_layout_position === 'extra-width') {
	$main_class = '';
	$main_container_class = ' container ';
	$layout_class = '';
}  elseif ($rodich_page_layout_position === 'right-sidebar') {
	$main_class = ' roch-blog-single-area ';
	$main_container_class = ' container ';
...
<!-- If VC page -->
<?php if ($rodich_page_layout_position === 'extra-width') { //VC Page with full blank page ?>
...
<?php } elseif ($rodich_page_layout_position === 'extra-width-banner') { //VC page with default banner
 if ($rodich_hide_banner == false) { ?>
		<!-- = Slider area start = \-->
...
<?php } else { //Regular Page
 ...
 if ($rodich_hide_banner == false) { ?>
	...
	<div class="<?php echo esc_attr($main_class . $rodich_content_padding); ?>" style="<?php echo esc_attr($rodich_custom_padding); ?>">
		<div class="<?php echo esc_attr($main_container_class); ?>">
			...
			<?php
				if ($rodich_page_layout_position === 'right-sidebar') {
					get_sidebar(); // Sidebar
				}
			?>
