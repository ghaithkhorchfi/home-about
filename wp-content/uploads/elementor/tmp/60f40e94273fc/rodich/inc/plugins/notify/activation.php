 ...
 */
require_once RODICH_FRAMEWORK . '/plugins/notify/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'rodich_register_required_plugins' );
 ...
 */
function rodich_register_required_plugins() {
	/*
    ...
    array(
	    'name'					=> 'Rodich Core',
	    'slug'     			=> 'rodich-core',
	    'source'				=> 'http://victorthemes.com/plugins/rodich-core.zip',
	    'required'			=> true,
	    'external_url'	=> 'https://victorthemes.com/wp-themes/rodich/',
    ),
    // Revolution Slider
    array(
