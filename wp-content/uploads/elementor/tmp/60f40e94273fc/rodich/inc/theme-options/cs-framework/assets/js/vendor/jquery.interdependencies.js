...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        /**
         * Rodich the condition of this rule in given jQuery context.
         *
         * The widget value is extracted using getControlValue()
         *
         * @param {jQuery} context The jQuery selection in which this rule is rodichd.
         *
         */
         ...
         * @param  {Object} enforced Recursive rule enforcer: undefined to rodich condition, true show always, false hide always
         *
         */
