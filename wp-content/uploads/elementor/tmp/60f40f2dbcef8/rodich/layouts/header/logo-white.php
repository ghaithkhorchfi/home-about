<?php
// Logo Image
$rodich_brand_logo_default = cs_get_option('brand_logo_default');
$rodich_brand_logo_retina = cs_get_option('brand_logo_retina');
...
<div class="roch-logo-white" style="<?php echo esc_attr($rodich_brand_logo_top); echo esc_attr($rodich_brand_logo_bottom); ?>">
	<a href="<?php echo esc_url(home_url( '/' )); ?>">
		<?php
			if (isset($rodich_brand_logo_default)){
				if ($rodich_brand_logo_retina){
					echo '<img src="'. esc_url(wp_get_attachment_url($rodich_brand_logo_retina)) .'" width="'. esc_attr($rodich_retina_width) .'" height="'. esc_attr($rodich_retina_height) .'" alt="logo" class="retina-logo">
						';
				}
				echo '<img src="'. esc_url(wp_get_attachment_url($rodich_brand_logo_default)) .'" alt="logo" class="default-logo" width="'. esc_attr($rodich_retina_width) .'" height="'. esc_attr($rodich_retina_height) .'">';
			} else {
