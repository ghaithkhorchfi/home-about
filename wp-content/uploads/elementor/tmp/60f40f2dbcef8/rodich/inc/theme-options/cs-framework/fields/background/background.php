...
class CSFramework_Option_background extends CSFramework_Options {
  ...
  public function output() {
    ...
    $button_title = ( isset( $button_title ) ) ? $button_title : esc_html__( 'Upload', 'rodich' );
    $frame_title  = ( isset( $frame_title  ) ) ? $frame_title  : esc_html__( 'Upload', 'rodich' );
    $insert_title = ( isset( $insert_title ) ) ? $insert_title : esc_html__( 'Use Image', 'rodich' );
