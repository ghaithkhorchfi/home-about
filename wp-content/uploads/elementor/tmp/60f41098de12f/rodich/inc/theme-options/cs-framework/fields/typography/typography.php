...
class CSFramework_Option_typography extends CSFramework_Options {
  ...
  public function output() {
    ...
    if( is_object( $google_json ) ) {
      ...
      echo '<optgroup label="'. esc_html__( 'Web Safe Fonts', 'rodich' ) .'">';
      ...
      echo '<optgroup label="'. esc_html__( 'Google Fonts', 'rodich' ) .'">';
      ...
      echo esc_html__( 'Error! Can not load json file.', 'rodich' );
